...
class DataLoaderS(object):
    # train and valid: Ratio of training and validation set.
    # test = 1 - train - valid
    def __init__(
        self,
        file_name,
        ...
        # Catch Pandas-generated NaNs & convert to 0.0 before poisoning tensors
    ...
    def build_predefined_adj(self):
        # Initialize empty dictionary with default value as an empty list
        ...
        # FIX: Add self-loops (Identity Matrix) to prevent
        # division by zero in Graph Convolutions
...
class DataLoaderM(object):
    def __init__(self, xs, ys, batch_size, pad_with_last_sample=True):
        ...
        :param ys:
        :param batch_size:
        :param pad_with_last_sample: pad with the last sample to make number
        of samples divisible to batch_size.
        """
